    ...
    }
{
    ...
    for x in all{
        if x.1 == false{
            ...
            PROJECTSTATES.update(deps.storage, prj_wallet.clone(), act)?;
            break;
        }
    }
    if prj_wallet == "" {
...
//add project        
       ...
       let msg = ExecuteMsg::AddProject{
            ...
            project_name: String::from("first"), 
            project_wallet: String::from("project1"),
            project_collected: Uint128::new(5000),
            creator_wallet: String::from("creator1"),
            project_website: String::from("first project url"), 
            project_about: String::from("first project info"),
            project_email: String::from("first email"), 
            project_ecosystem:String::from("first ecosystem"),
            project_category:String::from("first category")
        };
        ...
        let msg = ExecuteMsg::AddProject{
            ...
            project_name: String::from("second"), 
            project_wallet: String::from("project2"),
            project_collected: Uint128::new(1000),
            creator_wallet: String::from("creator2"),
            project_website: String::from("second project url"), 
            project_about: String::from("second project info"),
            project_email: String::from("second email"), 
            project_ecosystem:String::from("second ecosystem"),
            project_category:String::from("second category")
        };
